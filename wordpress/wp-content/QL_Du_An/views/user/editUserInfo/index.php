    ...
    <div class="max-w-lg mx-auto mt-10">
        <form action="" method="post">
            ...
            <div class="mb-4 flex items-center">
                ...
                <input class="w-2/3 px-3 py-2 border-2 border-cyan-500 rounded-md" type="text" name="name_user" value="<?php echo $staff->Name; ?>">
            </div>

            <div class="mb-4 flex items-center">
                <label for="gender" class="w-1/3 text-right mr-4">Giới tính:</label>
                <input class="w-2/3 px-3 py-2 border-2 border-cyan-500 rounded-md" type="text" name="gender_user" value="<?php echo $staff->Gender; ?>">
            </div>

            <div class="mb-4 flex items-center">
                <label for="birthday" class="w-1/3 text-right mr-4">Ngày sinh:</label>
                <input class="w-2/3 px-3 py-2 border-2 border-cyan-500 rounded-md" type="date" name="birthday_user" value="<?php echo $staff->BirthDay; ?>">
            </div>

            <div class="mb-4 flex items-center">
                <label for="phone" class="w-1/3 text-right mr-4">Số điện thoại:</label>
                <input class="w-2/3 px-3 py-2 border-2 border-cyan-500 rounded-md" type="text" name="phone_user" value="<?php echo $staff->Phone; ?>">
            </div>

            <div class="mb-4 flex items-center">
                <label for="email" class="w-1/3 text-right mr-4">Email:</label>
                <input class="w-2/3 px-3 py-2 border-2 border-cyan-500 rounded-md" type="text" name="email_user" value="<?php echo $staff->Email; ?>">
            </div>

            <div class="mb-4 flex items-start">
                <label for="address" class="w-1/3 text-right mr-4">Địa chỉ:</label>
                <textarea class="w-2/3 px-3 py-2 border-2 border-cyan-500 rounded-md resize-y" name="address_user"><?php echo $staff->Address; ?></textarea>
            </div>
